...
- [src/calculation-language.langium](src/calculation-language.langium) -  The grammar definition of your language
- [src/calculation-language-module.ts](src/calculation-language-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/calculation-language-validator.ts](src/calculation-language-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/calculation-language.monarch.ts](src/syntaxes/calculation-language.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/calculation-language.tmLanguage.json](syntaxes/calculation-language.tmLanguage.json) - Textmate based syntax highlighting instructions.
